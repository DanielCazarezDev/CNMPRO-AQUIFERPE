    ...
    const mapNews = (newsletter) => {
        return (
            <div key={newsletter.id} className="d-flex mt-3">
                ...
                <div>
                    <a className="mt-1 font-14" target="_blank" href={newsletter.url} rel="noreferrer">
                        <strong>{newsletter?.name}: </strong>
                        <span className="text-muted">{newsletter?.description}</span>
                    </a>
                </div>
            </div>
        );
                    ...
                    <Row>
                        <Col>
                            <div className="page-title-box">
                                ...
                                <h4 className="page-title">Recent Newsletters</h4>
                            </div>
                        </Col>
                    </Row>
